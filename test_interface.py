...
class PowerMeterApp:
    def __init__(self, root):
        ...
        self.canvas.place(relx=0.2, rely=0.6, anchor="center")
        ...
        self.start_button.place(relx=0.2, rely=0.8, anchor="center")
        ...
        self.error_text_box = tk.Text(self.root, height=5, width=50, font=("Arial", 16), wrap="word", state="disabled",
                                      bg=self.root.cget("bg"))
        self.error_text_box.place(relx=0.5, rely=0.4, anchor="center")
    ...
    def end_acquisition(self):
        ...
        self.save_button.place(relx=0.2, rely=0.9, anchor="center")
    ...
    def start_acquisition(self):
        ...
        self.end_button.place(relx=0.2, rely=0.8, anchor="center")
                ...
                if self.PRAY:
                    ...
                    if i == 15:
                        ...
                        if self.current_wl > 960 and self.current_wl < 990:
                            self.power_real_cache.append(A / 3.3)
                        elif self.current_wl > 1960 and self.current_wl < 1990:
                            self.power_real_cache.append(A / 2)
                        elif self.current_wl > 430 and self.current_wl < 460:
                            self.power_real_cache.append(A / 3.6)
